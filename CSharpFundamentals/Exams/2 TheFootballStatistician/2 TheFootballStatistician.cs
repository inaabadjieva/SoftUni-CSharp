...
namespace _2_TheFootballStatistician
{
    class Program
    {
        static void Main(string[] args)
        {
            ...
            while (true)
            {
                ...
                if (inputLine == "End of the league.") break;
            ...
            decimal priceForAllMatchesInLeva = (matchesCounter * payment) * 1.94m;
