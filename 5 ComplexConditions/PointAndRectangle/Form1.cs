...
{
    public partial class RectangleAndPoint : Form
    {
        public RectangleAndPoint()
        {
            InitializeComponent();
        }
        ...
        private void Draw()
        {
            ...
            var y1 = this.numericUpDownY2.Value;
            ...
            {
                this.lableInside.Text = "Inside";
            }
            else if (x > right || x < left || y < top || y > bottom)
            {
                this.lableInside.Text = "Outside";
            }
            else if (x == right || x == left || y == top || y == bottom)
            {
                this.lableInside.Text = "Border";
            }
